...
class VThread
{
  public:
   ...
   {
      auto jobTask = std::make_shared<
         std::packaged_task<typename std::result_of<F( VThreadResources*, Args... )>::type()> >(
   ...
   VThreadResources& getThreadResources() { return _resources; }
  private:
   std::thread _thread;
